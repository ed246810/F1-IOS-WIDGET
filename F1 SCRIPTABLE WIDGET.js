...
//Run btw 5 days - x(80) Mins after start time
Bweather=[],Vweather=[]
...
else if((Bsprint==false && VMins[1]>-100)||(Bsprint==true&&VMins[0]>-100))
{
	...
	if(Bsprint==true&&VMins[1]>-100)
	{//SPRINT WEEKEND QUALI HAVENT EMD
	wid.V.Title[0]="Quali",wid.V.Title[1]="Sprint"
		i0=1,i1=0
	}
	else if(Bsprint==true&&VMins[1]<-100)
	{//SPRINT WEEKEND, QUALI ENDED
		//SPRINT,RACE
		wid.V.Title[0]="Sprint",wid.V.Title[1]="Race"
		i0=0,i1=2
	}
	else
	{//NON SPRINT WEEKEND *QUALI NOT OVER
		//QUALI,RACE
...
//LEFT BOX
if(Bsprint==true&&VMins[1]>-100)
	{//SPRINT WEEKEND,QUALI SESSION HAVENT ENDED
		//QUALI,SPRINT
	//BOX A WEATHER
	if(wid.V.Days[0]<6)
	{
